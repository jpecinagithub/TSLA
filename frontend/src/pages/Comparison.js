...
export default function Comparison() {
    ...
    return (_jsxs("div", { className: "p-5 flex flex-col gap-5", children: [_jsx("h1", { className: "text-base font-bold text-white", children: "Strategy Comparison" }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-3", children: portfolios.map((p) => {
